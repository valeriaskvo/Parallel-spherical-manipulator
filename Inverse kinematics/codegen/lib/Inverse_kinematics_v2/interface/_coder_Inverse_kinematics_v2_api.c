/*
 * File: _coder_Inverse_kinematics_v2_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "Inverse_kinematics_v2",             /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
 ...
 * Return Type  : void
 */
  void Inverse_kinematics_v2_api(const mxArray * const prhs[2], int32_T nlhs,
  const mxArray *plhs[1])
{
  real_T (*q_v2)[4];
  ...
  q_v2 = (real_T (*)[4])mxMalloc(sizeof(real_T [4]));
  ...
  Inverse_kinematics_v2(*system_parameters, *phi_ee, *q_v2);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*q_v2);
}
 ...
 * Return Type  : void
 */
void Inverse_kinematics_v2_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  Inverse_kinematics_v2_xil_terminate();
  Inverse_kinematics_v2_xil_shutdown();
 ...
 * Return Type  : void
 */
void Inverse_kinematics_v2_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_Inverse_kinematics_v2_api.c
 *
 * [EOF]
 */
