...
matlabFunction(A_theta,'File', 'A_q1','Vars', [{eta_i}, {system_parameters}, {phi_ee}]);
matlabFunction(B_theta,'File', 'B_q1','Vars', [{eta_i}, {system_parameters}, {phi_ee}]);
matlabFunction(C_theta,'File', 'C_q1','Vars', [{eta_i}, {system_parameters}, {phi_ee}]);
...
matlabFunction(A_mu_1,'File', 'A_q2','Vars', [{eta_i}, {system_parameters}, {phi_ee},{q_1}]);
matlabFunction(B_mu_1,'File', 'B_q2','Vars', [{eta_i}, {system_parameters}, {phi_ee},{q_1}]);
matlabFunction(C_mu_1,'File', 'C_q2','Vars', [{eta_i}, {system_parameters}, {phi_ee},{q_1}]);
...
matlabFunction(q_3,'File', 'q3_find','Vars', [{eta_i}, {system_parameters}, {phi_ee},{q_1},{q_2}]);