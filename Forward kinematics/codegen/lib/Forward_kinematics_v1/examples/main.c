...
#include "Forward_kinematics_v1_terminate.h"
...
static void main_Forward_kinematics_v1(void);
...
static void main_Forward_kinematics_v1(void)
{
  ...
  /* Initialize function 'Forward_kinematics_v1' input arguments. */
  /* Initialize function input argument 'system_parameters'. */
  /* Initialize function input argument 'q'. */
  /* Call the entry-point 'Forward_kinematics_v1'. */
  argInit_5x1_real_T(dv);
  argInit_3x1_real_T(dv1);
  Forward_kinematics_v1(dv, dv1, phi);
}
