/*
 * File: _coder_Forward_kinematics_v1_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "Forward_kinematics_v1",             /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
 ...
 * Return Type  : void
 */
  void Forward_kinematics_v1_api(const mxArray * const prhs[2], int32_T nlhs,
  const mxArray *plhs[1])
{
  real_T (*phi)[3];
  ...
  Forward_kinematics_v1(*system_parameters, *q, *phi);
 ...
 * Return Type  : void
 */
void Forward_kinematics_v1_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  Forward_kinematics_v1_xil_terminate();
  Forward_kinematics_v1_xil_shutdown();
 ...
 * Return Type  : void
 */
void Forward_kinematics_v1_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_Forward_kinematics_v1_api.c
 *
 * [EOF]
 */
