###########################################################################
## Makefile generated for MATLAB file/project 'Forward_kinematics_v1'. 
## 
## Makefile     : Forward_kinematics_v1_rtw.mk
## Generated on : Wed Apr 01 16:21:45 2020
## MATLAB Coder version: 4.3 (R2019b)
## 
## Build Info:
## 
## Final product: ./Forward_kinematics_v1.lib
...
PRODUCT_NAME              = Forward_kinematics_v1
MAKEFILE                  = Forward_kinematics_v1_rtw.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2019b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2019b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/valer/DOCUME~1/INNOPO~1/DIPLOM~1/PSMGIT~1/FORWAR~1/codegen/lib/FORWAR~1
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
MODEL_HAS_DYNAMICALLY_LOADED_SFCNS = 
RELATIVE_PATH_TO_ANCHOR   = .
COMPILER_COMMAND_FILE     = Forward_kinematics_v1_rtw_comp.rsp
CMD_FILE                  = Forward_kinematics_v1_rtw.rsp
C_STANDARD_OPTS           = -fwrapv
CPP_STANDARD_OPTS         = -fwrapv
MODELLIB                  = Forward_kinematics_v1.lib
...
PRODUCT = ./Forward_kinematics_v1.lib
...
DEFINES_ = -D__USE_MINGW_ANSI_STDIO=1 -DMODEL=Forward_kinematics_v1 -DHAVESTDIO -DUSE_RTMODEL
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=Forward_kinematics_v1 -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)/rt_nonfinite.c $(START_DIR)/rtGetNaN.c $(START_DIR)/rtGetInf.c $(START_DIR)/Forward_kinematics_v1_data.c $(START_DIR)/Forward_kinematics_v1_initialize.c $(START_DIR)/Forward_kinematics_v1_terminate.c $(START_DIR)/Forward_kinematics_v1.c $(START_DIR)/Inverse_kinematics.c $(START_DIR)/fmincon.c $(START_DIR)/factoryConstruct.c $(START_DIR)/computeFiniteDifferences.c $(START_DIR)/factorQRE.c $(START_DIR)/factorQR.c $(START_DIR)/deleteColMoveEnd.c $(START_DIR)/solve.c $(START_DIR)/computeGrad_StoreHx.c $(START_DIR)/computeFval_ReuseHx.c $(START_DIR)/computeFval.c $(START_DIR)/linearForm_.c $(START_DIR)/setProblemType.c $(START_DIR)/maxConstraintViolation.c $(START_DIR)/modifyOverheadPhaseOne_.c $(START_DIR)/addBoundToActiveSetMatrix_.c $(START_DIR)/Weighted_error.c $(START_DIR)/driver.c $(START_DIR)/test_exit.c $(START_DIR)/computeGradLag.c $(START_DIR)/xgemv.c $(START_DIR)/xgeqp3.c $(START_DIR)/xzgeqp3.c $(START_DIR)/xzlarfg.c $(START_DIR)/xzlarf.c $(START_DIR)/xnrm2.c $(START_DIR)/computeQ_.c $(START_DIR)/sortLambdaQP.c $(START_DIR)/step.c $(START_DIR)/driver1.c $(START_DIR)/PresolveWorkingSet.c $(START_DIR)/countsort.c $(START_DIR)/RemoveDependentIneq_.c $(START_DIR)/feasibleX0ForWorkingSet.c $(START_DIR)/xgemm.c $(START_DIR)/phaseone.c $(START_DIR)/iterate.c $(START_DIR)/xrotg.c $(START_DIR)/compute_deltax.c $(START_DIR)/xpotrf.c $(START_DIR)/relaxed.c $(START_DIR)/BFGSUpdate.c $(START_DIR)/H_leg.c
...
OBJS = rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj Forward_kinematics_v1_data.obj Forward_kinematics_v1_initialize.obj Forward_kinematics_v1_terminate.obj Forward_kinematics_v1.obj Inverse_kinematics.obj fmincon.obj factoryConstruct.obj computeFiniteDifferences.obj factorQRE.obj factorQR.obj deleteColMoveEnd.obj solve.obj computeGrad_StoreHx.obj computeFval_ReuseHx.obj computeFval.obj linearForm_.obj setProblemType.obj maxConstraintViolation.obj modifyOverheadPhaseOne_.obj addBoundToActiveSetMatrix_.obj Weighted_error.obj driver.obj test_exit.obj computeGradLag.obj xgemv.obj xgeqp3.obj xzgeqp3.obj xzlarfg.obj xzlarf.obj xnrm2.obj computeQ_.obj sortLambdaQP.obj step.obj driver1.obj PresolveWorkingSet.obj countsort.obj RemoveDependentIneq_.obj feasibleX0ForWorkingSet.obj xgemm.obj phaseone.obj iterate.obj xrotg.obj compute_deltax.obj xpotrf.obj relaxed.obj BFGSUpdate.obj H_leg.obj
...
Forward_kinematics_v1_data.obj : $(START_DIR)/Forward_kinematics_v1_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Forward_kinematics_v1_initialize.obj : $(START_DIR)/Forward_kinematics_v1_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Forward_kinematics_v1_terminate.obj : $(START_DIR)/Forward_kinematics_v1_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Forward_kinematics_v1.obj : $(START_DIR)/Forward_kinematics_v1.c
	$(CC) $(CFLAGS) -o "$@" "$<"
