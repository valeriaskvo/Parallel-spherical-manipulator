 ...
 * Return Type  : double
 */
double Weighted_error(const double in1[5], const double in2[2], const double
                      in3[3], const double in4[3], const double in5[3])
{
  double t2;
  double t3;
  double t4;
  ...
  return in2[0] * ((((((((t172 * t172 + t114 * t114) + t132 * t132) + t53 * t53)
                       + t52 * t52) + t6 * t6) + t171 * t171) + t43 * t43) + t17
                   * t17) - in2[1] * ((((((((((((((((((((((((((t12 * ((t14 * t4 /
    2.0 - 1.7320508075688772 * ((t337 * 2.0 + t109) - t118) / 2.0) + t3 * t11 /
    2.0) + t378 * t108) - t378 * t55) - t15 * t490) - t15 * t13) - t10 * t107) -
    t10 * t7) - t12 * t67) + t175 * t9) + t175 * t174) + t9 * t174) - t176 * t69)
    + t177 * t181) - t485 * t486) + t107 * t7) + t490 * t13) - t127 * t207) -
    t108 * t55) - t177 * ((t14 * t44 / 2.0 - t3 * t253 / 2.0) +
    1.7320508075688772 * ((t324 * 2.0 - t2) + t78) / 2.0)) + t176 *
    ((1.7320508075688772 * ((t276 * 2.0 + t79) + t117) / 2.0 - t14 * t40 / 2.0)
     + t3 * t418_tmp / 2.0)) - t485 * t39) + t486 * t39) + t69 * t69) + t181 *
    t181) + t67 * t67) + t127 * t38) - t207 * t38);
}
