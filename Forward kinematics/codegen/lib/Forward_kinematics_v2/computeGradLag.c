 ...
 * Return Type  : void
 */
void b_computeGradLag(double workspace[36], int ldA, int nVar, const double
                      grad[6], int mIneq, int mEq, const int finiteFixed[6], int
                      mFixed, const int finiteLB[6], int mLB, const int
                      finiteUB[6], int mUB, double lambda)
{
  int idx;
  int iac;
  int iy;
 ...
 * Return Type  : void
 */
void computeGradLag(double workspace[6], int ldA, int nVar, const double grad[6],
                    int mIneq, int mEq, const int finiteFixed[6], int mFixed,
                    const int finiteLB[6], int mLB, const int finiteUB[6], int
                    mUB, double lambda)
{
  int idx;
  int iac;
