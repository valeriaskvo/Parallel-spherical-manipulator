...
/* Include Files */
#include "_coder_J_v2_api.h"
#include "_coder_J_v2_mex.h"
 ...
 * Return Type  : void
 */
  void J_v2_api(const mxArray * const prhs[2], int32_T nlhs, const mxArray *
                plhs[1])
{
  real_T (*J)[12];
  ...
  J = (real_T (*)[12])mxMalloc(sizeof(real_T [12]));
  ...
  J_v2(*system_parameters, *phi_ee, *J);
...
/*
 * File trailer for _coder_J_v2_api.c
 *
 * [EOF]
 */
