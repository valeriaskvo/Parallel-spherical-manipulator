...
def save_obj(obj, name = "A1_motor_calibration"):
    with open(name + '.pkl', 'wb') as f:
        pickle.dump(obj, f, pickle.HIGHEST_PROTOCOL)

def load_obj(name = "A1_motor_calibration"):
...
class A1_motor(object):
    def __init__(self, id, serial_port, pd = {"kp": 0.01, "kd": 0.7}, calib = False):
        ...
        print("Motor", id, "initialized in zero position",rad2deg(self.q), "[deg]")
